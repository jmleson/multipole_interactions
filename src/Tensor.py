...
from src.build_up_tensor_equations.construct_full_tensor import construct_all_tensor_terms
from src.latex_helping_functions import save_lines_as_latex_file
from src.settings import global_symbols, greek_names
...
class Tensor:
    ...
    def __init__(self, order:int):
        ...
        # if self.order == 6:#TODO remove!!!
        #     self.terms = self.terms[-15:]#TODO remove!!!
